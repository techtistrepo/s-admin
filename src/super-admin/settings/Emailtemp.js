        ...
        {/* </div> */}
          ...
          <div className='row  mb-30'>
            ...
            <div class="text-left secondary-menu">
              <ul>
                ...
                <li ><Link to={AdminRouteNames.Email} style={{ textDecoration: 'none' }} >Email</Link></li>
          ...
          <div class="white-box">
            <div class="mb-30">
              ...
              <div class="row mb-16">
                <div class="col-sm-5">
                  <label for="emailsubject">Email Subject<em>*</em></label>
              ...
              <div class="row ">
                <div class="col-sm-12">
                  <label for="emailbody">Email body<em>*</em> </label>
